...
router.put('/:id/approve', verifyToken, verifyAdmin, projectController.approveProject);

// Admin menolak proposal
router.put('/:id/reject', verifyToken, verifyAdmin, projectController.rejectProject);
...
router.put('/:id/status', verifyToken, verifySantri, projectController.finishProject);
